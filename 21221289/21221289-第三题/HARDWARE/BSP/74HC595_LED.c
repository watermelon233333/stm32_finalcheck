...
void DispUpdate1(u8 x1,u8 x2,u8 x3,u8 x4)
{
		...
		HC595_NG_0();
		HC595_Shift8bit_MSB_First(FontsTableCathode(x1));
		LED_DIG1_LATCH_1();
		delay_ms(1);
		LED_DIG1_LATCH_0();
	
		HC595_Shift8bit_MSB_First(FontsTableCathode(x2));
		LED_DIG2_LATCH_1();
		delay_ms(1);
		LED_DIG2_LATCH_0();

		HC595_Shift8bit_MSB_First(FontsTableCathode(x3));
		LED_DIG3_LATCH_1();
		delay_ms(1);
		LED_DIG3_LATCH_0();

		HC595_Shift8bit_MSB_First(FontsTableCathode(x4));
		LED_DIG4_LATCH_1();
		delay_ms(1);
		LED_DIG4_LATCH_0();
